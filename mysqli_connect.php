...
if (file_exists('/home/infost490s3/secrets.settings.php')) { include '/home/infost490s3/secrets.settings.php'; } // Require secrets
if (file_exists('secrets.settings.php')) { include 'secrets.settings.php'; } // Require secrets
