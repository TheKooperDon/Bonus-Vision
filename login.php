...
if (!isset($_SESSION['agent']) OR ($_SESSION['agent'] != md5($_SERVER['HTTP_USER_AGENT']))) {
	...
	<form class= "card p-3 bg-light" action="login.php?login" method="POST">
		<p class="form-floating">Email Address: <input class="form-control" id="floatingInput" type="text" placeholder="name@example.com" name="email" size="20" maxlength="60" /> <label for="floatingInput">Email Address</label> </p>
